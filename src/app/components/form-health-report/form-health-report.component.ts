...
export class FormHealthReportComponent implements OnInit {
  ...
  bloodGlucoseLevel = new FormControl<number | null>(null, [Validators.required]);
  mobility = new FormControl<string>('', [Validators.required]);
  hydrationLevel = new FormControl<string>('', [Validators.required]);
  cognitiveEmotionalAssessment = new FormControl<string>('', [Validators.required]);
  bloodOxygenLevel = new FormControl<number | null>(null, [Validators.required]);
  ...
  ngOnInit() {
    if (this.initialData) {
      ...
      this.cognitiveEmotionalAssessment.setValue(data.cognitiveEmotionalAssessment);
